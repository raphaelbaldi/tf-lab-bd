-- LIMPA AS TABELAS ANTES DE INSERIR DADOS, COMEÇANDO NAS FOLHAS
TRUNCATE TABLE TF_JOGOS;
TRUNCATE TABLE TF_JOGADORES;
TRUNCATE TABLE TF_TIMES;
TRUNCATE TABLE TF_CIDADES;
TRUNCATE TABLE TF_ESTADOS;
