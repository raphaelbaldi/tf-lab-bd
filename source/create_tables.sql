...
DROP IF EXISTS TF_JOGOS;
DROP IF EXISTS TF_JOGADORES;
DROP IF EXISTS TF_TIMES;
DROP IF EXISTS TF_CIDADES;
DROP IF EXISTS TF_ESTADOS;
...
(
   ...
   ID_MANDANTE NUMBER (2) NOT NULL,
   GOLS_MANDANTE NUMBER (2) NOT NULL,
   ID_VISITANTE NUMBER (2) NOT NULL,
   GOLS_VISITANTE NUMBER (2) NOT NULL,
   DATA DATE NOT NULL,
   ID_VENCEDOR NUMBER (2), -- SE VENCEDOR É NULL => EMPATE
